...
//int battery_in = analogRead(BATT_IN_PIN);
//
//  float battery_voltage = battery_in / batt_calibrate;
//
//
//        //low battery - switch to mains
//  if (battery_voltage <= 10.6){// && source_current == 0){
//    digitalWrite(RELAY_PIN, HIGH);
//
...
//  }
//
//          //battery charged - switch to solar
//  else if (battery_voltage > 10.6){// && source_current == 1){
//    digitalWrite(RELAY_PIN, LOW);
//
//    Serial.print("ADC Input: ");
//    Serial.println(battery_in);
